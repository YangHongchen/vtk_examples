...
// int main_002 (int argc, char* argv[])
// {
...
//     cutActor2D->GetProperty()->SetLineWidth (1.0);
...
//     // 根据切割结果大小设置缩放
//     double dx = cutBounds[1] - cutBounds[0];
//     double dy = cutBounds[3] - cutBounds[2];
//     double maxSize = (dx > dy ? dx : dy);
//     camera->SetParallelScale (maxSize / 0.5); // 正好能看到完整切面
