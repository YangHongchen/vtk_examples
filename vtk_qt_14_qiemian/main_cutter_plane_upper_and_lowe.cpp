...
//     upperActor->GetProperty()->SetOpacity (1);
...
//     lowerActor->GetProperty()->SetOpacity (1);
...
//     upperCutActor->GetProperty()->SetLineWidth (1.5);
...
//     lowerCutActor->GetProperty()->SetLineWidth (1.5);
