...
bool PatientFileTransferManager::copyFileToUploadDirectory (const QString &sourcePath, bool overwrite, int stlType)
{
    ...
    emit fileUploadCompleted (targetPath, stlType);
    m_uploading = false;
    return true;
}
